...
*/
    ...
    //not sure if we should really be testing for equality with doubles
    ...
    public int hashCode() {
        return Objects.hash(n, this.magnitude());
    }
    ...
    public static void main(String[] args) {
        ...
        Vector x = new Vector(xdata);
        Vector y = new Vector(ydata);
        StdOut.println(x.plus(y));
        // StdOut.println(x.equals(y));
        // StdOut.println("x hash: " + x.hashCode());
        // StdOut.println("y hash: " + y.hashCode());
    }
}